...
\addbibresource{bibliography_patrick.bib} % The filename of the bibliography
\addbibresource{bibliography_ricardo.bib} % The filename of the bibliography
...
\thesistitle{Quantum Machine Learning} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
