...
Quantum computing is the usage of qubits in circuits to execute operations and measure a result. The usage of rotations on single qubits allows the manipulation of probabilities of single states, which collapse onto $0$ or $1$ when measuring. 
