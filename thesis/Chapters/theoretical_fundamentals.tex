...
\begin{equation}
    ...
    \begin{split}
        ...
        \ket{\psi_1} &=\ \sqrt{0.643}\begin{pmatrix} 1 \\ 0\end{pmatrix} + \sqrt{0.357}\begin{pmatrix} 0 \\ 1\end{pmatrix}
        \ket{\psi_1} &=\ \begin{pmatrix}\sqrt{0.643}\\ \sqrt{0.357}\end{pmatrix}\\
        \mathrm{RX}(\theta)\ket{0} &=\ \begin{pmatrix}\sqrt{0.643}\\ \sqrt{0.357}\end{pmatrix} \\
        \begin{pmatrix}\cos{\frac{\theta}{2}} \\ -i\sin{\frac{\theta}{2}}\end{pmatrix} &=\ \begin{pmatrix}\sqrt{0.643}\\ \sqrt{0.357}\end{pmatrix}\\
        \theta_{cos} &=\ 2(\acos{\sqrt{0.643}}) =\ 1.2807\\
        \theta_{sin} &=\ 2(\asin{\sqrt{0.357}}) =\ 1.2807\\
...
\begin{figure}
    ...
    \scalebox{1.0}{
    \Qcircuit @C=1.0em @R=0.2em @!R { \\
    	 	\nghost{{q} :  } & \lstick{{q} :  } & \gate{\mathrm{R_Y}\,(\mathrm{1.281})} & \qw & \qw\\
    \\ }}
    \caption{Caption}
    \label{fig:circuit_for_histogram}
\end{figure}
