...
\begin{figure}
    ...
    \begin{subfigure}{.5\textwidth}
        ...
        \caption{A basic Q-Sphere that shows all possible states of a 4 qubit circuit, as well as the probability of each state. The probability is encoded into the width of the dots next to the state labels. As all dots are equal, it is clear that all states have the same probability of being measured.}
...
\begin{figure}[!h]
    ...
    \end{subfigure}
    \caption{The circuit with qubit state $\ket{0}$ at position $\ket{\psi_0}$ and its corresponding \bloch\ visualization.}
