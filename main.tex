...
\todo{abstract}
Quantum computing has been put into the spotlight by recent advancements and achievements, from proofs of quantum advantage to breakthroughs in the available hardware. Manufacturers that offer open accessibility to quantum hardware enable the furthering of the field through open research and engineering. Meanwhile, machine learning has turned into a critical component of computer science for the past decade and enabled a multitude of solutions previously deemed unachievable. Proposals in the field of quantum computing suggest and point to quantum \emph{enhanced} machine learning algorithms being even more promising than purely classical offerings. This thesis takes on the task of comparing quantum enhanced support vector machines with purely quantum neural networks\todo{vielleicht auch noch klassisch?}. Simultaneously, a quantum neural network is designed to take on the task of solving a data-intensive NP-hard problem. Whilst the current machine learning offerings for quantum circuits are quite limited, the results of both experiments show promising, reproducible results. At the same time, the results show that quantum computing using normal, non machine learning circuits, has enough potential to solve even NP-hard problems.
